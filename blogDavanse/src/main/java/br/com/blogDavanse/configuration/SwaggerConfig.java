package br.com.blogDavanse.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.blogDavanse.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Davanse").description("Projeto API Spring - Blog Pessoal")
